var app = angular.module("app banderitas", []);

app.controller("exCtrl", function($scope){
    $scope.texto = "Salve Opeth!";
    $scope.song = "Bleak";
    $scope.teams = new Array;
    $scope.teamflags = new Array;
    $scope.data = [{
        "venue": "Kazan",
    ...
    $scope.data.forEach(element => {
        $scope.teams.push(element.home_team_country);
        $scope.teams.push(element.away_team_country);
        
        switch(element.home_team_country){
            case "Korea Republic":
                $scope.teamflags.push("kr");
                break;
            case "Mexico":
                $scope.teamflags.push("mx");
                break;
            case "Serbia":
                $scope.teamflags.push("rs");
                break;
            case "Switzerland":
                $scope.teamflags.push("ch");
                break;
            default:
                break;
        }

        switch(element.away_team_country){
            case "Germany":
                $scope.teamflags.push("de");
                break;
            case "Sweden":
                $scope.teamflags.push("se");
                break;
            case "Brazil":
                $scope.teamflags.push("br");
                break;
            case "Costa Rica":
                $scope.teamflags.push("cr");
                break;
            default:
                break;
        }
